<?php
namespace App\Libraries\Mavenlink;
...
class MavenlinkApi
{
  ...
  {
    return $this->getJson(TimeEntry::getResourcesPath() . "?workspace_id=" . $workspaceId . "&include=user,workspace");
  }
  ...
  {
    return $this->getJson(Expense::getResourcesPath() . "?workspace_id=" . $workspaceId . "&include=user,workspace");
  }
  ...
  /** Chiranjib's Code Start **/
  
  function getTimeEntriesWithParam($params='include=user,story,workspace')
  {
    return $this->getJson(TimeEntry::getResourcesPath() . "?".$params);
  }
  function getAllTimeEntriesFromWorkspaceWithParam($workspaceId,$params='include=user,story,workspace')
  {
    return $this->getJson(TimeEntry::getResourcesPath() . "?workspace_id=" . $workspaceId."&".$params);
  }
  function getAllCustomFieldsFromWorkspace($workspaceId)
  {
    return $this->getJson(CustomField::getResourcesPath() . "?with_subject_id=".$workspaceId."&subject_type=Workspace");
  }
  function getAllExpensesWithParam($params='include=workspace,story')
  {
    return $this->getJson(Expense::getResourcesPath() . "?" . $params);
  }
  function getAllExpensesFromWorkspaceWithParam($workspaceId,$params='include=story,workspace')
  {
    return $this->getJson(Expense::getResourcesPath() . "?workspace_id=" . $workspaceId."&".$params);
  }
  
  function getWorkspacesWithParam($params='include=custom_field_values')
  {
    return $this->getJson(Workspace::getResourcesPath() . "?".$params);
  }
  
  function getSingleWorkspacesWithParam($workspaceId,$params='include=custom_field_values')
  {
    return $this->getJson(Workspace::getResourcesPath() . "?only=".$workspaceId."&".$params);
  }
  
  function getJsonForAllUser()
  {
    $resourcesPath = User::getResourcesPath();
    return $this->getJson($resourcesPath);
  }
